...
class VBEPostings:
    ...
    def encode(postings_list):
        ...
        """
        gap_based_list = []
        for i, v in enumerate(postings_list):
            if i == 0:
                gap_based_list.append(v)
            else:
                gap_based_list.append(v - postings_list[i-1])
    ...
    def decode(encoded_postings_list):
        ...
        for i, gap in enumerate(gap_based_list):
            if i == 0:
                postings_list.append(gap)
            else:
                postings_list.append(gap + postings_list[i-1])
